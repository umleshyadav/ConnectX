    ...
    const handelLogOut = async () => {
        ...
        if (confirmlogout === authUser.username) {
            ...
            try {
                ...
                sessionStorage.removeItem('chatapp')
                setAuthUser(null)
                setLoading(false)
                navigate('/login')
            } catch (error) {
            ...
            {searchUser?.length > 0 ? (
                <>
                    ...
                    <div className='mt-auto px-1 py-1 flex'>
                        <button onClick={handSearchback} className='bg-gray-700 rounded-full px-2 py-1 self-center hover:scale-105 transition-transform duration-300'>
